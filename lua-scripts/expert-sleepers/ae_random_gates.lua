...
for i = 1, 32 do sequence.steps[i] = 0 end

local function randomizeSequence()
    for i = 1, 32 do sequence.steps[i] = math.random(100) end
end
...
return {
    ...
    encoder2Push = function(self) randomizeSequence() end,
    ...
    draw = function(self)
        local yOffset = 20
        drawText(10, yOffset,
                 "Step: " .. sequence.stepIndex .. "/" .. sequence.numSteps)
        drawText(10, yOffset + 10, "Threshold: " .. sequence.threshold)
        drawText(10, yOffset + 20, "Gate Length: " .. sequence.gateLength)
        drawText(10, yOffset + 30,
                 "Freeze: " .. (self.parameters[4] == 2 and "ON" or "OFF"))
        drawText(10, yOffset + 40, "Gate State: " ..
                     (sequence.gateRemainingSteps > 0 and "ON" or "OFF"))
    end
}
