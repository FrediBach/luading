...
describe('Display designer rendering', () => {
  it('renders a labelled full-size authoring dialog with every static primitive path', () => {
    ...
    for (const label of ['Select', 'Pixel line', 'Smooth line', 'Outline box', 'Filled box', 'Pixel box', 'Pixel circle', 'Smooth circle', 'Polygon', 'Bézier curve', 'Standard text', 'Tiny text']) {
