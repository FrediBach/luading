...
describe('command bar utilities', () => {
  it('renders distinct Lua and signal-clock transports with shortcut hints', () => {
    ...
    expect(markup).not.toContain('<span>Display designer</span>')
    expect(markup).toContain('role="tooltip">Open Display designer</span>')
    expect(markup).toContain('aria-label="Script files"')
    expect(markup).toContain('aria-haspopup="dialog"')
    expect(markup).toContain('aria-expanded="false"')
    expect(markup).not.toContain('aria-label="Import Lua script"')
    expect(markup).not.toContain('aria-label="Export Lua script"')
